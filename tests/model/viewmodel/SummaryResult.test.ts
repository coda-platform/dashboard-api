...
const received_1 = JSON5.parse(
  fs.readFileSync("./mock/tasks/received_task_1.json5").toString(),
);
const returned_1 = JSON5.parse(
  fs.readFileSync("./mock/tasks/ret_task_1.json5").toString(),
);
const req1 = {
  selectors: [
    {
...
const received_2 = JSON5.parse(
  fs.readFileSync("./mock/tasks/received_task_2.json5").toString(),
);
const returned_2 = JSON5.parse(
  fs.readFileSync("./mock/tasks/ret_task_2.json5").toString(),
);
const req2 = {
  selectors: [
    {
      ...
      filters: [
        ...
        },
        {
          ...
          operator: <SummaryOperator>"isNot",
          value: "null",
        },
      ],
      fields: [],
